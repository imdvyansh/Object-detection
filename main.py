...
#prototxtPath = join(dirname(__file__), "Object_Detection\MobileNetSSD_deploy.prototxt")
#weightsPath = join(dirname(__file__), "Object_Detection\MobileNetSSD_deploy.caffemodel")

#prototxtPath = "Object_Detection\MobileNetSSD.txt"
#weightsPath = "Object_Detection\MobileNetSSD_deploy.caffemodel"
